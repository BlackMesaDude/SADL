...
namespace SADL.Rage.GeneralResources.Common.Types
{
    ...
    public class uint_r : ResourceSystemBlock
    {
        ...
        /// Reads a uint value
        /// </summary>
        /// <param name="reader">Reader wich will help for reading the uint</param>
        /// <param name="parameters">Additional parameters for data grabbing</param>
        public override void Read(ResourceDataReader reader, params object[] parameters) => Value = reader.ReadUInt32();

        /// <summary>
        /// Writes a uint value
        /// </summary>
        /// <param name="writer">Writer wich will help for writing the uint</param>
        /// <param name="parameters">Additional parameters for data grabbing</param>
